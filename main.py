    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "acecwply" in url:
                ...
                signed_api = f"https://cp-api-sigma.vercel.app/sign?url={url}"
                ...
                url = requests.get(f'https://api.classplusapp.com/cams/uploader/video/jw-signed-url?url=https://cp-api-sigma.vercel.app/sign?url={url}', headers={'x-access-token': f'{cptoken}'}).json()['url']
...
async def text_handler(bot: Client, m: Message):
    ...
    try:
            ...
            if "acecwply" in url:
                ...
                url = url.replace("https://cpvod.testbook.com/","https://media-cdn.classplusapp.com/drm/")
                url = 'https://cp-api-sigma.vercel.app/sign?url={url}' + url
                mpd, keys = helper.get_mps_and_keys(url)
                url = mpd
                keys_string = " ".join([f"--key {key}" for key in keys])
                ...
                url = requests.get(f'https://api.classplusapp.com/cams/uploader/video/jw-signed-url?url=https://cp-api-sigma.vercel.app/sign?url={url}', headers={'x-access-token': f'{raw_text4}'}).json()['url']
